...
private:
   ...
   size_t iTest = 0u;
   std::pair<size_t, size_t> destinations;
   size_t i_count_items_inspected = 0u;
...
{
   try {
    std::cout << "Advent of Code 11!\n";
    Day11::ReadValues_1("d:\\test\\aoc2022\\test_values11.txt");
   }
